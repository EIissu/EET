...
<details>
<summary>the original README, in full</summary>
...
and vlad. Licensed under [GPL-3.0](LICENSE). Before opening a pull request, see the
[contributing guide](CONTRIBUTING.md), the [code of conduct](CODE_OF_CONDUCT.md) and the
