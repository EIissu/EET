...
```
dotnet run --project Destiny Career Stats/src/Destiny.Api   # then open the printed URL
...
dotnet user-secrets --project Destiny Career Stats/src/Destiny.Api \
...
```bash
dotnet build Career Stats.slnx
dotnet test  Career Stats.slnx
```
